...
if ($file != "") {
  ...
  for ($x = 0; $x < $anzteams; $x++) {
    if (isLeagueVB() == TRUE) { //Volleyball
      $x3 = getTeamNumber($tab2[$x]); //Volleyball
    } else {
...
<table class="lmoMiddle" cellspacing="0" cellpadding="0" border="0">
  ...
  if ($tabpkt==0) {?>
            <th>&nbsp;</th>
            <th <?php echo $dummy . '>' . $text[37]; ?></th><?php
  }?>
            <th align="left" width="2">&nbsp;</th>
            <th align="left" colspan="3"><?php echo $text[38]; ?></th>
  ...
  for ($x = 1; $x <= $anzteams; $x++) {
    ...
    if ($tabpkt==1) {?>
      ...
      if ($minus==2) {?>
          ...
          <tr>
            <th align="right" colspan="<?php echo $breite; ?>">
